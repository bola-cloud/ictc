...
<div class="container py-4">
    <h2>{{ __('lang.consultancy_interests') }}</h2>

    <!-- Search -->
    <form method="GET" action="{{ route('admin.interests.consultancies.index') }}" class="mb-4">
        <div class="input-group">
            ...
            <a href="{{ route('admin.interests.consultancies.export') }}" class="btn btn-success ms-2 me-2">{{ __('lang.export_excel') }}</a>
        </div>
    </form>
