...
<div class="container py-4">
    <h2>{{ __('lang.employment_interests') }}</h2>

    <!-- Search -->
    <form method="GET" action="{{ route('admin.interests.jobs.index') }}" class="mb-4">
        <div class="input-group">
            ...
            <a href="{{ route('admin.interests.jobs.export') }}" class="btn btn-success ms-2 me-2">{{ __('lang.export_excel') }}</a>
        </div>
    </form>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="7" class="text-center">{{ __('lang.no_data_found') }}</td>
                </tr>
                @endforelse
            </tbody>
        </table>
