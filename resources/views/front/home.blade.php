  ...
  <section id="gallery" style="padding: 50px 0; background-color: #f9f9f9;">
    <div class="container">
        ...
        <div class="row">
            <!-- Photo Gallery Link -->
            <div class="col-md-6">
                <div class="gallery-item position-relative mt-3" onclick="openPhotoGallery()">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkdPFA6r_IbzQJcyXrKT5TSritv0S_iWwFmw&s">
                    <div class="overlay">
                        <h2>Photo Gallery</h2>
                    </div>
                </div>
            ...
            <!-- Video Gallery Link -->
            <div class="col-md-6">
                <div class="gallery-item position-relative mt-3" onclick="openVideoGallery()">
