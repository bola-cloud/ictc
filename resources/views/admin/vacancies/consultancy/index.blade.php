...
<div class="container py-4">
    <div class="card p-5">
        <div class="d-flex justify-content-center align-items-center p-4">
            <h2>{{ __('lang.consultancy_vacancies') }}</h2>
        </div>
        ...
        <div class="mb-3 text-end">
            <a href="{{ route('admin.consultancies.create') }}" class="btn btn-primary">{{ __('lang.add_new') }}</a>
        </div>
            ...
            <tbody>
                @forelse($vacancies as $index => $vacancy)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.consultancies.edit', $vacancy) }}" class="btn btn-sm btn-warning">{{ __('lang.edit') }}</a>
                            <form action="{{ route('admin.consultancies.destroy', $vacancy) }}" method="POST" style="display:inline-block">
                                @csrf @method('DELETE')
